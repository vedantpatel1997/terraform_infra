...
spoke_client_id         = "<spoke-client-id>"
spoke_client_secret     = "<spoke-client-secret>"
spoke_client_object_id  = "<spoke-service-principal-object-id>"
hub_subscription_id     = "f1c89731-86b0-4cd4-bd2d-f2347c1d62d2"
hub_tenant_id           = "<hub-tenant-id>"
hub_client_id           = "<hub-client-id>"
